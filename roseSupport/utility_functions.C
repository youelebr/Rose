...
#define DBG_MAQAO std::cout<<"In "<<__FILE__<<" FUNCTION "<<__FUNCTION__<<" , line: "<<__LINE__<<"\n"; //DBG_MAQAO
...
SgProject* frontend (const std::vector<std::string>& argv, bool frontendConstantFolding ) {
  //DBG_MAQAO
...
/*! \brief Call to backend, generates either object file or executable.
    ...
    \internal The error code is returned, but it might be appropriate to make
              ...
              the error code.
 */
int backend ( SgProject* project, UnparseFormatHelp *unparseFormatHelp, UnparseDelegate* unparseDelagate ) {
