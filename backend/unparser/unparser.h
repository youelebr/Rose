...
std::string spaceBeforeStmt(SgLocatedNode* node);
std::string spaceBeforeStmt(SgLocatedNode* node, int sizeOfKeyword);
std::string spaceBeforeStmt(int number_of_space);
